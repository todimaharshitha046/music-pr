	...
	return (
		<div className={styles.container}>
			<div className={styles.head}>
				...
				<img src="https://simg.nicepng.com/png/small/0-5307_description-heart-sg2001-transparent-png-mng4a3-clipart-black.png" alt="like songs" />
				<div className={styles.playlist_info}>
					<p>Playlist</p>
					<h1>Liked Songs</h1>
					<span>By Sid Sriram</span>
				</div>
			</div>
